...
import com.example.geolearn.databinding.ActivityQuizBinding
import com.example.geolearn.databinding.ScoreDialogBinding
...
class QuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onClick(view: View?) {
        ...
        if(clickedBtn.id==R.id.next_btn){
            ...
            clickedBtn.setBackgroundColor(getColor(R.color.purple))
        }
    }

    @SuppressLint("SetTextI18n")
    private fun finishQuiz(){
        val totalQuestions: Int = questionModelList.size
